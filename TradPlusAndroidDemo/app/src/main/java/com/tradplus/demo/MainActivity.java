    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isChild.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                TradPlusSdk.setCOPPAIsAgeRestrictedUser(MainActivity.this, b);
            }
        });

        cbCCPA = (CheckBox) findViewById(R.id.do_not_sell);
        cbCCPA.setChecked(TradPlusSdk.getGDPRDataCollection(MainActivity.this) == TradPlusSdk.PRIVACY_ACCEPT_KEY);
