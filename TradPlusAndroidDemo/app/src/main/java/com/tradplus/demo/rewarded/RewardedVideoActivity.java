...
//        SegmentUtils.initCustomMap(customMap);//设置APP维度的规则，对全部placement有效
        ...
        mRewardInterstitial = new TradPlusInterstitialExt(this, TestAdUnitId.REWRDVIDEO_ADUNITID,autoload);
                ...
                reward_load.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (autoload) {
                            ...
                            //广告位是否达到缓存的配置上线
                            if (mRewardInterstitial.isAllReady())
        ...
        //初始化广告位
        mRewardInterstitial.initUnitId();


        //进入广告位场景时调用
        mRewardInterstitial.entryAdScenario();
...
//**********注意事项（3）设置监听
    ...
    public void onInterstitialFailed(TradPlusInterstitial tradPlusInterstitial, TradPlusErrorCode tradPlusErrorCode) {
        ...
        if (tradPlusInterstitial != null) {
            ...
            Log.d("TradPlus", "RewardedVideo Failed ,code : " + code + ", errormessage :" + errormessage);
        }
        tv.setText("广告加载失败");
    }
